...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // This prevents 403 errors when registering/logging in without a token
        ...
        // 2. Check if the Authorization header is present and valid
        ...
        // 5. Always hand off to the next filter in the chain
        filterChain.doFilter(request, response);
    }
}